...
function Signup() {
  ...
  return (
    <div className="login-page flex flex-col items-center min-h-[75vh]">
      <h2 className="text-3xl font-bold mb-5 text-white">Create an Account</h2>
      ...
      <form className="form-login flex flex-col gap-4 w-80" onSubmit={handleSignup}>
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="username" className="label-input text-white font-semibold text-sm">Username</label>
          <input 
            id="username"
            name="username"
            type="text" 
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="email" className="label-input text-white font-semibold text-sm">Email</label>
          <input 
            id="email"
            name="email"
            type="email" 
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="password" className="label-input text-white font-semibold text-sm">Password</label>
          <input 
            id="password"
            name="password"
            type="password" 
        ...
        <div className="radio-btn flex flex-col gap-5 mt-2">
          <span className="label-input text-white font-semibold text-sm">Account Type</span>
      ...
      <p className="foot-signup mt-6 text-sm text-white font-medium ">
        Already have an account? <Link to="/login" className="underline font-bold hover:text-gray-200">Login</Link>
      </p>
    </div>
  )
}
