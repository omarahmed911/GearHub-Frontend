    ...
    <div className="login-page flex flex-col items-center  min-h-[75vh]">
      ...
      <form className="form-login flex flex-col gap-4 w-80 " onSubmit={handleLogin}>
        <div className="flex flex-col gap-1 ">
          <label htmlFor="emailOrUsername" className="label-input text-white font-semibold text-sm">Email or Username</label>
          <input 
            id="emailOrUsername"
      ...
      <p className="mt-6 text-sm text-white font-medium">
        Don't have an account? <Link to="/signup" className="underline font-bold hover:text-gray-200">Create account</Link>
      </p>
    </div>
  )
}
